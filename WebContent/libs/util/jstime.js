...
{   
    ...
    {   
        ...
        case 'ww' :partStr = myDate.WeekNumOfYear(myDate);break;  
...
//| 取得当前日期所在周是一年中的第几周  
//+---------------------------------------------------  
Date.prototype.WeekNumOfYear = function(date){  
...
/**
 * 获取周第一天(周日) 日期 （yyyy-MM-dd）
 * @param year 年份
 * @param weeknum 周数
 * eg: getStartDayOfWeek(2013,37) returns:'2013-09-08'
 */ 
function getStartDayOfWeek(year,weeknum){
	var s= StringToDate(year+"-01-01").getDay();//该年第一天星期几
	var r= addDay(year+"-01-01", (weeknum-1)*7-s);
	return r;
}
