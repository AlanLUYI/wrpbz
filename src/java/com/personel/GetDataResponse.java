...
public class GetDataResponse  implements java.io.Serializable {
    private GetDataResponseGetDataResult getDataResult;

    public GetDataResponse() {
    }

    public GetDataResponse(
           GetDataResponseGetDataResult getDataResult) {
     ...
     */
    public GetDataResponseGetDataResult getGetDataResult() {
        return getDataResult;
    }
     ...
     * @param getDataResult
     */
    public void setGetDataResult(GetDataResponseGetDataResult getDataResult) {
        this.getDataResult = getDataResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("", ">GetDataResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getDataResult");
        elemField.setXmlName(new javax.xml.namespace.QName("", "GetDataResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("", ">>GetDataResponse>GetDataResult"));
